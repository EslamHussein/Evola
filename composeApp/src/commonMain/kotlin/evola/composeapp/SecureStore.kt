 ...
 * being retired with auth). Android: EncryptedSharedPreferences; iOS: NSUserDefaults for now
 * (Keychain deferred, matching the existing iOS session-storage choice). */
